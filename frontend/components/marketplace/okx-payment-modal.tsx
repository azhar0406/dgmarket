...
export function OKXPaymentModal({
  ...
  const getProgressPercentage = () => {
    ...
    // ✅ FIXED: Clamp the percentage to max 100%
    const maxSteps = PROCESSING_STEPS.length; // Use length, not length-1
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-1">
          ...
          {error && (
            <Alert variant="destructive" className="py-2">
              ...
              <AlertDescription className="text-sm leading-tight break-words overflow-hidden">
        ...
        <div className="flex-shrink-0 pt-4 border-t">
          ...
          {/* {process.env.NODE_ENV === 'development' && (
            <div className="text-xs text-muted-foreground space-y-1 p-2 bg-muted/30 rounded mt-2 max-h-24 overflow-y-auto">
